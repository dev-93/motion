import { BaseComponents, Component } from "../component.js";
...
export class PageItemComponent extends BaseComponents<HTMLUListElement> implements SectionContainer {
